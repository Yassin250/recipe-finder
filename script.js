// DOM Elements
        ...
        function displayMeals(meals) {
            ...
            meals.forEach(meal => {
                mealsContainer.innerHTML += `<div class="meal" data-meal-id="${meal.idMeal}">
        ...
        async function handleMealclick(e) {
            ...
            try {
                ...
                if (data.meals && data.meals[0]) {
                  ...
                  <img src="${meal.strMealThumb}" alt="${meal.strMeal}" class="meal-details-img"><h2 class="meal-details-title">${meal.strMeal}</h2>
                  <div class="meal-details-category">
                  <span>${meal.strCategory || "Uncategorized"}</span></div>
